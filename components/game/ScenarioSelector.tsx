                ...
                return (
                  <Card
                    ...
                    className={cn(
                      ...
                      gc.glow,
                      !scenario.background_image_url && 'bg-[var(--bg-secondary)]'
                    )}
                    style={{
                      ...
                      <CardHeader className="pb-2 pt-5 px-4">
                        <div className="flex items-start justify-between gap-2 mb-1.5">
                          <span className={cn(
                            ...
                            gc.text,
                            scenario.background_image_url && 'px-2 py-0.5 rounded-full backdrop-blur-sm bg-black/30 border border-white/10'
                          )}>
                            {genre}
                          </span>
                        </div>
                        ...
                        <CardDescription className={cn(
                          ...
                          scenario.background_image_url ? 'text-zinc-300' : 'text-[var(--text-secondary)]'
                        )}>
                      ...
                      <CardContent className="mt-auto pt-0 px-4 pb-4">
                        <div className="flex items-center justify-between mb-3">
                          {state && (
                            ...
                            scenario.background_image_url ? 'text-zinc-400' : 'text-[var(--text-muted)]'
                          )}>
